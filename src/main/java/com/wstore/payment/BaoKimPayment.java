...
public class BaoKimPayment {
	...
	// Mã merchante site
	private String merchant_id = "22239";	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	private String secure_pass = "736e0881b84c935f";	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
